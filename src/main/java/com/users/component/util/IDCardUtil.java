...
public class IDCardUtil {
    ...
    public static void main(String[] args) {
        //身份证号码校验
        boolean mark1 = isIDCard("431024199509220915");
        System.out.println("mark1="+mark1);
        boolean mark2 = isIDCard("431024199509220916");
        System.out.println("mark2="+mark2);
        boolean mark3 = isIDCard("431024199509210915");
        System.out.println("mark3="+mark3);
        boolean mark4 = isIDCard("450981198802261753");
        System.out.println("mark4="+mark4);
        boolean mark5 = isIDCard("53042419921021003X");
