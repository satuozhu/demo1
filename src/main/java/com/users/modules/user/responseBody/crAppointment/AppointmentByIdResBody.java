 ...
 */
@Data
@ApiModel(value = "AppointmentByIdResBody响应参数类", description = "根据预约ID查看预约信息响应参数类")
public class AppointmentByIdResBody implements Serializable {

    private static final long serialVersionUID = 6909023265285236701L;
