...
/**
 * 查询正常运转的诊室（医生-时间段-诊室）响应参数类
 */
@Data
@ApiModel(value = "SelectNormalHouseResBody响应参数类", description = "查询正常运转的诊室（医生-时间段-诊室）响应参数类")
public class SelectNormalHouseResBody implements Serializable {

    private static final long serialVersionUID = -1036075922835754783L;
