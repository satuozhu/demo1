 ...
 */
@Data
@ApiModel(value = "AppointmentHistoryListResBody响应参数类", description = "用户查看历史预约列表响应参数类")
public class AppointmentHistoryListResBody implements Serializable {

    private static final long serialVersionUID = -8917644870721051663L;
