 ...
 */
@Data
@ApiModel(value = "DoctorInfoByIdResBody响应参数类", description = "根据医生编号查询医生信息响应参数类")
public class DoctorInfoByIdResBody implements Serializable {

    private static final long serialVersionUID = -8206553478801389341L;
