 ...
 */
@Data
@ApiModel(value = "SelectDoctorInfoTopResBody响应参数类", description = "医生好评率top3响应参数类/医生详情")
public class SelectDoctorInfoTopResBody implements Serializable {

    private static final long serialVersionUID = -2435160893209319411L;
