 ...
 */
@Data
@ApiModel(value = "PrescriptionByIdResBody响应参数类", description = "根据处方ID查询处方响应参数类")
public class PrescriptionByIdResBody implements Serializable {

    private static final long serialVersionUID = -256732224556542495L;
