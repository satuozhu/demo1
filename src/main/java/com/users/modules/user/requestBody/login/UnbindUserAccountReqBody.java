 ...
 * 用户解除绑定(手机号、邮箱)请求参数类
 */
@ApiModel(value = "UnbindUserAccountReqBody请求参数类", description = "用户解除绑定(手机号、邮箱)请求参数类")
public class UnbindUserAccountReqBody implements Serializable {

    private static final long serialVersionUID = -6917676063031247536L;
    ...
    public String toString() {
        return "UnbindUserAccountReqBody{" +
                "userId=" + userId +
