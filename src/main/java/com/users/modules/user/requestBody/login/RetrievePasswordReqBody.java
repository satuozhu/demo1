 ...
 * 找回密码(手机号、邮箱)请求参数类
 */
@ApiModel(value = "RetrievePasswordReqBody请求参数类", description = "找回密码(手机号、邮箱)请求参数类")
public class RetrievePasswordReqBody implements Serializable {

    private static final long serialVersionUID = 1295562607464280546L;

    @ApiModelProperty(value = "用户账号", required = true, allowableValues = "13049881621")
    private String userAccount;

    @ApiModelProperty(value = "类型：1手机注册2手机重置密码3手机验证码登录4手机验证码绑定；11邮箱注册12邮箱重置密码13邮箱验证码登录14邮箱验证码绑定", dataType = "Integer", required = true, allowableValues = "2")
